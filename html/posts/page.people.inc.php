        ...
        if ($items_loaded != 0) {
            ...
            if ($result['items_loaded'] < $items_all) {
                ...
                <header class="top-banner loading-banner">
                    ...
                    <div class="prompt">
                        <button onclick="Likers.more('<?php echo $profileInfo['username']; ?>', '<?php echo $postInfo['id']; ?>', '<?php echo $result['elementId']; ?>'); return false;" class="button green loading-button"><?php echo $LANG['action-more']; ?></button>
                    </div>
                    ...
                    if ($postExists) {
                        ...
                        if ($items_all > 20) {
                            ...
                            <header class="top-banner loading-banner">
                                ...
                                <div class="prompt">
                                    <button
                                            onclick="Likers.more('<?php echo $profileInfo['username']; ?>', '<?php echo $postInfo['id']; ?>', '<?php echo $result['elementId']; ?>'); return false;"
