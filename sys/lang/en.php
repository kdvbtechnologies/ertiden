...
//    $TEXT['action-join'] = "Регистрация";
    ...
    $TEXT['main-page-promo-google-app'] = "%s is where you go, so you can create posts and chat with your friends anytime, anywhere. Stay in touch with your friends with the mobile application %s. Available for Android.";
    $TEXT['main-page-promo-login'] = "%s - a social network through which you can share interesting news, images and videos from YouTube with your friends and all the people..";
    $TEXT['main-page-promo-explore'] = "%s gives you the ability to see the full stream of publications from users and communities, to search for people, products and communities without registration! Read posts, watch videos, search for information and explore the social network!";

    // For version 5.7

    $TEXT['page-recently-deleted'] = "Recently Deleted";
    $TEXT['page-recently-deleted-desc'] = "Posts deleted no more than 14 days ago can be restored or deleted permanently, without the possibility of restore in the future.";
    $TEXT['label-menu-recently-deleted'] = "Recently Deleted";
    $TEXT['label-restore-post'] = "Restore Post?";
    $TEXT['label-restore-post-desc'] = "If you restore it, people will be able to see and interact with it again.";
    $TEXT['label-delete-post'] = "Delete Post?";
    $TEXT['label-delete-post-desc'] = "If you delete it, you will not be able to restore it.";
    $TEXT['action-restore'] = "Restore";
    $TEXT['action-delete-permanently'] = "Delete permanently";

    // For version 5.9

    $TEXT['action-pin'] = "Pin";
    $TEXT['action-unpin'] = "Unpin";
    $TEXT['label-item-pinned'] = "Post pinned";
    ...
    $TEXT['tooltip-otp-verification-title'] = "SMS OTP Verification";
    $TEXT['tooltip-otp-verification-desc'] = "Link your mobile number and get credits that you can use to send gifts and activate additional features!";
    $TEXT['tooltip-otp-verification-action'] = "Link number";

    $TEXT['label-payments-otp-verification-bonus'] = "OTP Verification Bonus";
