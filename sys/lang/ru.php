<?php
    ...
    $TEXT['page-recently-deleted'] = "Недавно удаленные";
    $TEXT['page-recently-deleted-desc'] = "Посты удаленные не более 14 дней назад можно восстановить или удалить навсегда, без возможности восстановления в будущем.";
    $TEXT['label-menu-recently-deleted'] = "Недавно удаленные";
    $TEXT['label-restore-post'] = "Восстановить Пост?";
    $TEXT['label-restore-post-desc'] = "Если вы восстановите это, люди снова смогут видеть его и взаимодействовать с этим.";
    $TEXT['label-delete-post'] = "Удалить Пост?";
    $TEXT['label-delete-post-desc'] = "Если вы удалите это, вы не сможете его восстановить.";
    $TEXT['action-restore'] = "Восстановить";
    $TEXT['action-delete-permanently'] = "Удалить навсегда";

    // For version 5.9

    $TEXT['action-pin'] = "Закрепить";
    $TEXT['action-unpin'] = "Открепить";
    $TEXT['label-item-pinned'] = "Пост закреплен";
    ...
    $TEXT['tooltip-otp-verification-title'] = "Привязка номера по смс";
    $TEXT['tooltip-otp-verification-desc'] = "Свяжите свой номер мобильного телефона и получите кредиты, которые можно использовать для отправки подарков и активации дополнительных функций!";
    $TEXT['tooltip-otp-verification-action'] = "Привязать номер";

    $TEXT['label-payments-otp-verification-bonus'] = "Бонус за привязку номера по смс";
