...
class account extends db_connect
{
    ...
    public function signup($username, $fullname, $password, $email, $language = 'en')
    {
        ...
        $stmt = $this->db->prepare("INSERT INTO users (state, login, fullname, passw, email, salt, regtime, admob, last_authorize, language, allowMessages, ip_addr) value (:state, :username, :fullname, :password, :email, :salt, :createAt, :admob, :last_authorize, :language, :allowMessages, :ip_addr)");
