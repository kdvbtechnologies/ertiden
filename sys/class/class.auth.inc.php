...
class auth extends db_connect
{
    ...
    static function unsetSession()
    {
        ...
        unset($_SESSION['user_otp_verified']);
    }
    ...
    static function setCurrentUserVerified($user_verified)
    {
        $_SESSION['user_verified'] = $user_verified;
    }
    ...
    static function setCurrentUserOtpVerified($user_otp_verified)
    {
        $_SESSION['user_otp_verified'] = $user_otp_verified;
    }

    static function getCurrentUserOtpVerified()
    {
        if (isset($_SESSION) && isset($_SESSION['user_otp_verified'])) {

            return $_SESSION['user_otp_verified'];
