...
class draw extends db_connect
{
    ...
    static function post($post, $LANG, $helper = null, $showComments = false, $menuType = 0, $page_id = 0)
    {
        ...
        <li class="custom-list-item post-item" data-id="<?php echo $post['id']; ?>">
            ...
            <div class="mb-2 item-header">
                        ...
                        <?php
                            ...
                            if ($menuType == 0) {
                                ...
                                if ((auth::isSession() && $post['fromUserId'] == auth::getCurrentUserId()) || (isset($groupInfo) && $groupInfo['accountAuthor'] == auth::getCurrentUserId())) {
                                    ...
                                    ?>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="Post.remove('<?php echo $post['id']; ?>', 1); return false;"><?php echo $LANG['action-remove']; ?></a>
                                    <?php

                                    if ($page_id == PAGE_PROFILE) {

                                        if ($post['pinned'] == 1) {

                                            ?>
                                            <a class="dropdown-item pin-item-action" href="javascript:void(0)" onclick="Post.pin('<?php echo $post['id']; ?>'); return false;"><?php echo $LANG['action-unpin']; ?></a>
                                            <?php

                                        } else {

                                            ?>
                                            <a class="dropdown-item pin-item-action" href="javascript:void(0)" onclick="Post.pin('<?php echo $post['id']; ?>'); return false;"><?php echo $LANG['action-pin']; ?></a>
                                            <?php
                                        }
                                    }
                                ...
                                if (auth::isSession() && $post['fromUserId'] == auth::getCurrentUserId()) {
                                    ...
                                    ?>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="Post.remove('<?php echo $post['id']; ?>', 0); return false;"><?php echo $LANG['action-delete-permanently']; ?></a>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="Post.restore('<?php echo $post['id']; ?>'); return false;"><?php echo $LANG['action-restore']; ?></a>
                                    <?php
                                }
                            }
                ...
                <span class="post-item-time">
                    <a href="/<?php echo $post['fromUserUsername']; ?>/post/<?php echo $post['id']; ?>">
                    <?php echo $time->timeAgo($post['createAt']); ?></a>

                    <?php
                        if ($post['deviceType'] == 1) {

                            ?>
                                <span class="user-badge post-device-badge ml-1" rel="tooltip" title="<?php echo $LANG['hint-item-android-version']; ?>"><i class="iconfont icofont-brand-android-robot"></i></span>
                            <?php
                        }
                    ?>

                    <?php
                        if ($post['deviceType'] == 2) {

                            ?>
                                <span class="user-badge post-device-badge ml-1" rel="tooltip" title="<?php echo $LANG['hint-item-ios-version']; ?>"><i class="iconfont icofont-brand-apple"></i></span>
                            <?php
                        }
                    ?>
                    ...
                    <?php
                        ...
                        if ($post['pinned'] == 1 && $page_id == PAGE_PROFILE) {

                            ?>
                                <span class="user-badge post-pinned-badge ml-1" rel="tooltip" title="<?php echo $LANG['label-item-pinned']; ?>"><i class="iconfont icofont-tack-pin"></i></span>
                            <?php
                        }
                    ?>
            ...
            <div class="item-meta post-item-content">
                ...
                <?php
                    ...
                    if ($post['postType'] == 0) {
                        ...
                        ?>
                            <div class="post-text m-2"><?php echo $post['post']; ?></div>
                        <?php
                                    ...
                                    <li class="custom-list-item repost-item post-item" data-id="<?php echo $rePost['id']; ?>">
                                        ...
                                        <div class="item-meta post-item-content">
                                            ...
                                            <?php
                                                ...
                                                if (strlen($rePost['videoUrl']) > 0) {

                                                    ?>

                                                    <video width = "100%" height = "auto" style="max-height: 300px" controls>
                                                        <source src="<?php echo $rePost['videoUrl']; ?>" type="video/mp4">
                                                    </video>
